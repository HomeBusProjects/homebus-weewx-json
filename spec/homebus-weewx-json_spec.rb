...
require 'homebus-weewx-json/options'
require 'homebus-weewx-json/app'

require 'homebus/config'

class TestHomebusWeewxJson < HomebusWeewxJson::App
...
describe HomebusWeewxJson do
  context "Version number" do
    it "Has a version number" do
      expect(HomebusWeewxJson::VERSION).not_to be_nil
      expect(HomebusWeewxJson::VERSION.class).to be String
    end
  end 
end

describe HomebusWeewxJson::Options do
  context "Methods" do
    options = HomebusWeewxJson::Options.new
    ...
    it "Uses the VERSION constant" do
      expect(options.version).to eq(HomebusWeewxJson::VERSION)
    end
...
describe TestHomebusWeewxJson do
  context "Methods" do
    options = HomebusWeewxJson::Options.new
    app = HomebusWeewxJson::App.new(options)
