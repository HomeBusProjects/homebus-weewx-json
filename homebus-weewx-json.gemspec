...
require_relative 'lib/homebus-weewx-json/version'

Gem::Specification.new do |spec|
  spec.name = 'homebus-weewx-json'
  spec.version = HomebusWeewxJson::VERSION
  ...
  spec.homepage = 'https://github.com/HomeBusProjects/homebus-weewx-json'
  spec.license = 'MIT'
  spec.required_ruby_version = ">= #{File.read('.ruby-version')}"

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/HomeBusProjects/homebus-weewx-json'
